...
**emitChanges** - уведомляет подписчиков об изменениях модели (Параметры: event - тип произошедшего изменения, payload - дополнительные данные изменения (опционально))
...
**items** - массив элементов коллекции, соответсвует интерфейсу IItem

    *Методы*

**getItem(id)** - возвращает элемент из массива по идентификатору

**getItems()** - возвращает весь массив элементов

**setItems(items)** - полностью заменяет коллекцию элементов
...
**toggleItem(item)** - переключает состояние элемента (добавляет/удаляет из массива)
...
**checkItem(id)** - проверяет наличие товара в корзине, возвращает boolean значение

**deleteItem(id)** - удаляет конкретный товар по ID
...
**order** - защищенное поле, хранящее объект данных заказа, соответсвует интерфейсу IOrder

    *Сеттеры*

**payment** - устанавливает способ оплаты, который соответсвует определенному типу PaymentMethod

**email**, **phone**, **address** - устанавливают данные покупателя

**total** - устанавливает итоговую сумму заказа, принимает число

**itemsId** - устанавливает массив ID товаров в заказе

**itemsData** - отдельная реализация установки свойств total и items в order. Принимает массив объектов товаров например из BasketItems и обрабатывает оттуда внутри класса отделяя массив id и вычесляя сумму товаров
...
**counter** (setter) - обновляет значение счетчика товаров в корзине

**catalog** (setter) - отображает переданные элементы (массив элементов) в разделе каталога

**locked** (setter) - блокирует/разблокирует интерфейс страницы
...
**content** (setter) - устанавливает содержимое модального окна

**open()** - открывает модальное окно

**close()** - закрывает модальное окно

**render()** - реализует отрисовку модального окна
...
**id** - устанавливает уникальный идентификатор карточки

**title** - обновляет отображение названия товара

**price** - обновляет отображение цены

**description** - устанавливает описание (принимает строку или массив строк)

**image** - обновляет изображение товара

**category** - устанавливает категорию товара

    *Геттер*

**id** - возвращает идентификатор карточки
